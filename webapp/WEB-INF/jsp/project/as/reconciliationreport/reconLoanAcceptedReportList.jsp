...
<aos:html title="放款（代付）对账报表" base="http" lib="ext">
<aos:body>
</aos:body>
</aos:html>
<aos:onready>
	<aos:viewport layout="border">
		<aos:formpanel layout="column" columnWidth="1" region="north"
			...
			<aos:combobox fieldLabel="交易渠道" name="routed_third_channel_id_" editable="false"
			...
			<aos:datefield fieldLabel="订单完成时段" name="start_response_time_" emptyText="开始日期"
				columnWidth="0.186" />
		...
		<aos:gridpanel id="_g_api_request" url="reconLoanAcceptedReportService.reconLoanAcceptedReportPage" 
		onrender="_g_loan_query" pageSize="30" autoScroll="true" forceFit="false" region="center">
			<aos:docked forceBoder="1 0 1 0">
				<aos:dockeditem xtype="tbtext" text="放款（代付）对账报表" />
				<aos:dockeditem xtype="tbseparator" />
			</aos:docked>
			<aos:column type="rowno" />
			<aos:column header="放款受理指令ID" dataIndex="id_" celltip="true" width="100" align="center"/>
			...
			<aos:column header="借款人姓名" dataIndex="customer_name_" width="70" align="center"/>
			<aos:column header="借款人身份证" dataIndex="customer_idcard_" width="100" align="center"/>
			<aos:column header="借款人手机号" dataIndex="customer_cellphone_" width="100" align="center"/>
			<aos:column header="产品编号" dataIndex="product_code_" width="100" align="center"/>
			<aos:column header="产品名称" dataIndex="product_name_" width="100" align="center"/>
			...
			<aos:column header="放款要素账号" dataIndex="loan_account_" width="200" align="center"/>
			<aos:column header="放款要素户名" dataIndex="loan_name_" width="70" align="center"/>
			<aos:column header="放款要素身份证" dataIndex="loan_idcard_" width="100" align="center"/>
			<aos:column header="放款要素手机号" dataIndex="loan_cellphone_" width="100" align="center"/>
			<aos:column header="交易金额（收款金额）" dataIndex="loan_amount_" width="70" align="center"/>
	...
	<script type="text/javascript">
		...
		function fn_exportexcel() {
			...
			AOS.ajax({
				params: params,
				url:'reconLoanAcceptedReportService.isEqualCondition',
				ok:function(data){
					if(data.appmsg == 'true'){
						AOS.file('do.jhtml?router=reconLoanAcceptedReportService.exportExcel&juid=${juid}');
					}else{
