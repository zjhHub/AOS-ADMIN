	...
	<aos:viewport layout="border" >
		<aos:hiddenfield name="id_" id="id_" value="${snapshot_id_}" />
				 ...
				 <aos:formpanel id="_f_detail"  region="north" rowSpace="25" labelWidth="200">
					...
					<aos:textfield name="customer_code_" fieldLabel="账户的客户CRM编码" value="${po['customer_code_']}"  readOnly="true" columnWidth="0.33" />
					<aos:textfield name="idcard_" fieldLabel="账户的客户身份证"  value="${po['idcard_']}"  readOnly="true" columnWidth="0.33" />
					<aos:textfield name="name_" fieldLabel="账户的客户姓名"  value="${po['name_']}"  readOnly="true" columnWidth="0.33" />
