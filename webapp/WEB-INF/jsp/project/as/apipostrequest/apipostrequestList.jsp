...
<aos:html title="API-post请求监控" base="http" lib="ext">
<aos:body>
</aos:body>
</aos:html>
<aos:onready>
	<aos:viewport layout="border">
		...
		<aos:gridpanel id="_g_api_request" url="apiPostRequestService.apiPostRequestPage" onrender="_g_loan_query" pageSize="30" autoScroll="true" region="center">
			...
			<aos:column header="归属业务线" dataIndex="platform_id_" celltip="true" width="40" align="center"/>
			...
			<aos:column header="请求时间" dataIndex="time_" width="50" align="center"/>
			<aos:column header="响应时间" dataIndex="response_time_" width="50" align="center" rendererField="third_channel_id_"/>
			<aos:column header="响应码" dataIndex="response_code_" width="30" align="center"/>
...
<script type="text/javascript">
	...
	function _btn_detail_onclick() {
		...
		parent.fnaddtab('apiPostRequestService.findDetail&uuid_=' + uuid_, 'Post请求'+uuid_+'的详情', uuid_);
	}
</script>
