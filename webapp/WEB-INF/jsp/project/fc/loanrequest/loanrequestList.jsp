...
<aos:html title="借款端，放款请求" base="http" lib="ext">
<aos:body>
</aos:body>
</aos:html>
<aos:onready>
	<aos:viewport layout="border">
		...
		<aos:formpanel layout="column" columnWidth="1" region="north"
			...
			<aos:textfield fieldLabel="放款请求ID" name="uuid_" emptyText="填写登账请求ID"
				columnWidth="0.33" />
			...
			<aos:combobox fieldLabel="放款接口" name="service_code_" editable="false"
				columnWidth="0.33" dicField="loanservice_codes_" />
		...
		<aos:gridpanel id="_g_loan" url="loanRequestService.loanrequestPage"
			onrender="_g_loan_query" pageSize="30" autoScroll="true"
			region="center">
			<aos:docked forceBoder="1 0 1 0">
				<aos:dockeditem xtype="tbtext" text="放款请求列表" />
			...
			<aos:column dataIndex="request_uuid_" hidden="true" header="划扣请求ID"
				width="80" />
			<aos:column header="放款请求ID" dataIndex="uuid_" celltip="true"
				width="80" />
			<aos:column header="归属业务线" dataIndex="platformName" celltip="true"
				width="80" />
			<aos:column header="IP地址" dataIndex="ip_address_" width="90" />
			<aos:column header="放款接口" dataIndex="service_code_" celltip="true" rendererField="loanservice_codes_" 
				width="120" />
		...
		<aos:window id="_w_req" title="放款请求的请求内容" onshow="_w_req_onshow"
			...
			<aos:formpanel id="req_info" layout="column"
				...
				<aos:fieldset title="摘要" labelWidth="70" columnWidth="1"
					margin="0 10 0 0">
					<aos:textfield name="uuid_" fieldLabel="放款请求" maxLength="50"
					...
					<aos:textfield name="ip_address_" fieldLabel="IP地址" readOnly="true"
						columnWidth="0.5" />
					<aos:combobox name="service_code_" fieldLabel="放款接口" dicDataType="number" dicField="loanservice_codes_" editable="false"
		...
		<aos:window id="_w_resp" title="放款请求的响应内容" onshow="_w_rsp_onshow"
			width="640" height="490">
			<aos:formpanel id="rsp_info" layout="column" 
				labelWidth="800" width="750">
				<aos:fieldset title="摘要" labelWidth="70" columnWidth="1"
					margin="0 10 0 0">
					<aos:textfield name="request_uuid_" fieldLabel="放款请求"
	...
	<script type="text/javascript">
		...
		function _w_req_onshow() {
			...
			AOS.ajax({
				...
				url : 'loanRequestService.loanDetails',
				ok : function(data) {
					AOS.reset(req_info);
