...
<aos:html title="登账请求列表" base="http" lib="ext">
<aos:body>
</aos:body>
</aos:html>
<aos:onready>
	<aos:viewport layout="border">
		...
		<aos:formpanel layout="column" columnWidth="1" region="north"
			...
			<aos:textfield fieldLabel="登账请求ID" name="uuid_" emptyText="填写登账请求ID"
				columnWidth="0.33" />
			...
			<aos:combobox fieldLabel="登账接口" name="service_code_" editable="false"
				columnWidth="0.33" dicField="entry_service" />
		...
		<aos:gridpanel id="_g_loan" url="logRequestService.logRequestPage"
			onrender="_g_loan_query" pageSize="30" autoScroll="true"
			region="center">
			<aos:docked forceBoder="1 0 1 0">
				<aos:dockeditem xtype="tbtext" text="登账请求列表" />
				<aos:dockeditem xtype="tbseparator" />
			</aos:docked>
			<aos:column type="rowno" />

			<aos:column dataIndex="request_uuid_" hidden="true" header="登账请求uuid"
				width="80" />
			<aos:column header="登账请求ID" dataIndex="uuid_" celltip="true"
				width="80" />
			<aos:column header="归属业务线" dataIndex="platformName" celltip="true"
				width="80" />
			<aos:column header="IP地址" dataIndex="ip_address_" width="90" />
			<aos:column header="登账接口" dataIndex="service_code_" celltip="true" rendererField="entry_service" 
				width="120" />
		...
		<aos:window id="_w_req" title="登账请求内容" onshow="_w_req_onshow"
			...
			<aos:formpanel id="req_info" layout="column" 
				...
				<aos:fieldset title="摘要" labelWidth="70" columnWidth="1"
					margin="0 10 0 0">
					<aos:textfield name="uuid_" fieldLabel="登账请求" maxLength="50"
					...
					<aos:textfield name="ip_address_" fieldLabel="IP地址" readOnly="true"
						columnWidth="0.5" />
					<aos:combobox name="service_code_" fieldLabel="登账接口" dicDataType="number" dicField="entry_service" editable="false"
		...
		<aos:window id="_w_resp" title="登账响应内容" onshow="_w_rsp_onshow"
			width="640" height="490">
			<aos:formpanel id="rsp_info" layout="column"
				labelWidth="800" width="750">
				<aos:fieldset title="摘要" labelWidth="70" columnWidth="1"
					margin="0 10 0 0">
					<aos:textfield name="request_uuid_" fieldLabel="登账请求"
	...
	<script type="text/javascript">
		...
		function _w_req_onshow() {
			...
			AOS.ajax({
				...
				url : 'logRequestService.logDetails',
				ok : function(data) {
					AOS.reset(req_info);
