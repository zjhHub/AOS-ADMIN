...
<aos:body>
	<div id="_div_tips" class="x-hidden" style="line-height: 25px; margin-right: 10px;">
		<ul>
			<li>申请年龄：18周岁以上；</li>
	...
	<aos:viewport layout="border">
		...
		<aos:panel region="west" width="250" bodyBorder="0 1 0 0">
			...
			<aos:panel height="100">
				<aos:layout type="vbox" align="stretch" />
				<aos:button text="调阅信用卡申请审核信息" icon="add2.png" scale="medium" margin="10" onclick="#_w_max.show();" />
		...
		<aos:panel region="center" border="false" layout="border">
			<aos:panel region="north" >
				<aos:formpanel id="_f_query" layout="column" labelWidth="70" header="false">
			...
			<aos:gridpanel id="_g_account" url="demoService.listAccounts" region="center" onrender="_g_account_query"
		...
		<aos:window id="_w_max" layout="border" maximized="true" title="信用卡申请审核资料" onshow="_w_max_onshow">
			...
			<aos:panel region="center" bodyBorder="0 0 0 1" layout="border">
				<aos:panel layout="fit" region="north" height="60" title="信用认证信息" bodyBorder="1 0 1 0">
					<aos:formpanel layout="column" labelWidth="70" border="false">
						<aos:textfield name="name_" fieldLabel="持卡人姓名" readOnly="true" columnWidth="0.25" />
						<aos:combobox name="card_type_" fieldLabel="卡类型" readOnly="true" dicField="card_type_" columnWidth="0.25" />
						<aos:textfield name="card_id_" fieldLabel="信用卡号" readOnly="true" columnWidth="0.25" />
						<aos:textfield name="id_no_" fieldLabel="身份证号" readOnly="true" columnWidth="0.24" />
					</aos:formpanel>
				</aos:panel>
				...
				<aos:panel layout="fit" region="south" height="100" title="备注信息">
					<aos:formpanel layout="column" labelWidth="60" border="false">
						<aos:textareafield name="remark_" readOnly="true" columnWidth="1" />
					</aos:formpanel>
				</aos:panel>
			</aos:panel>
