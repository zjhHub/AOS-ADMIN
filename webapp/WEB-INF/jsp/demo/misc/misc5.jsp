	...
	<aos:viewport layout="fit">
		...
		<aos:panel border="false">
			...
			<aos:panel>
				...
				<aos:formpanel layout="column" labelWidth="70" header="false"
					border="true" flex="1" margin="5" padding="5 0 0 5">
			
					<aos:textfield name="kkcg_" fieldLabel="开卡成功" value="5个"
						readOnly="true" columnWidth=".5" />
					<aos:textfield name="sxzje_" fieldLabel="授信总金额" value="100000.00"
						readOnly="true" columnWidth=".5" />
					<aos:textfield name="jjs_" fieldLabel="拒件数" value="10000件"
						readOnly="true" columnWidth=".5" />
					<aos:textfield name="jjzje_" fieldLabel="拒件总金额" value="567890.00"
						readOnly="true" columnWidth=".5" />
				</aos:formpanel>
				<aos:formpanel layout="column" labelWidth="70" header="false"
					border="true" flex="1" margin="5" padding="5 0 0 0">
				...
				<aos:formpanel layout="column" labelWidth="70" header="false"
					border="true" flex="1" margin="5" padding="5 5 0 0">
